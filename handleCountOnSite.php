...
$furniture = mysqli_query($link, "SELECT * FROM `furniture` WHERE `employee_id` IS NOT NULL");
$i = 2;
$totalCount = 0;
$objExcel->setActiveSheetIndex(0)->mergeCells('A1:F1')->setCellValue('A1', 'Количество продоваемого товара')->getStyle()->getFont()->setSize(20);
...
$objExcel->setActiveSheetIndex(0)->getStyle("A2:F$i")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
...
$i = $i - 2;
$objExcel->getActiveSheet()->getStyle("A2:F$i")->applyFromArray($border);

$objWriter = PHPExcel_IOFactory::createWriter($objExcel, 'Excel2007');

$objWriter->save('Отчет_продоваемого_товара.xlsx');
