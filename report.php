...
?>
  ...
  <body>
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
              <div class="navbar-nav">
                ...
                <a class="nav-link active" href="report.php">Отчеты</a>
      ...
      <?php
          ...
          <h5>Потребовать запрос:</h5>
            <p style="text-align: center; padding: 3px;">
                <a href="handleCountOnSite.php" style="color: black;">Количество продаваемого товара</a>
            </p>
            <p style="text-align: center; padding: 3px;">
                <a href="handleCountOnWarehouse.php" style="color: black;">Количество и стоимость товара на складе</a>
            </p>
            <p style="text-align: center; padding: 3px;">
                <a href="handleCountContract.php" style="color: black;">О заключенных договорах на поставку товар</a>
            </p>
            <p style="text-align: center; padding: 3px;">
                <a href="handleOfSales.php" style="color: black;">О продажах</a>
            </p>
